    ...
    ");
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-warning btn-sm" href="peminjaman_edit.php?id=<?php echo $d['pinjam_id'] ?>">
                          <i class="fa fa-cog"></i>
                        </a>
                        <a class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus?')" href="peminjaman_hapus.php?id=<?php echo $d['pinjam_id'] ?>">
